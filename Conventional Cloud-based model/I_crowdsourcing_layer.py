...
#Crowd-sourcing layer receives sensing data from the sensing layer and sends the data to cloud layer directly. There is no CDMFC layer.
...
print "Socket to send data to cloud layer is created successfully"
print
s2 = socket.socket()		 
